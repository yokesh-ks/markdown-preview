            ...
            <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              <li className="row-span-3">
                ...
                >
                  ...
                  <div className="mb-2 mt-3 text-lg font-medium">Markdown Live Preview - IngeniousClan</div>
                  <p className="text-sm leading-tight text-muted-foreground">
                    A powerful markdown editor with live preview. Write, edit, and preview your markdown in real-time.
                    <br />
                    Open Source.
                  </p>
                </a>
